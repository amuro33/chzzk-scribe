...
`;
    ...
    for (const chat of sortedChats) {
        ...
        if (chat.messageTime !== undefined && chat.messageTime !== null) {
            // Use messageTime and subtract video start time
            relativeMs = chat.messageTime - startTs;
        } else {
            // Fallback to playerMessageTime if available            
            continue;
        }
